...
function FirstScreenContentPart() {
    ...
    return (
        <div className="z-10 FirstScreenContentPart">
            <div
                className={`mt-85 absolute left-[calc(50%_-_400px)] rounded-3xs bg-gray-100 w-[50rem] h-[18.75rem] flex flex-row items-center justify-center p-[2.5rem] box-border Content ${isVisible ? 'visible' : ''}`}
            >
