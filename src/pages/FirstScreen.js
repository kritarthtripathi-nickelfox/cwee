...
function FirstScreen() {
  ...
  return (
    <div className="relative min-h-screen">
      <div className="fixed inset-0 bg-cover bg-center FirstScreen" />
      <div className="ImageContainer">
        {scrollY < 300 ? (
          <>
            <img className="LogoImage" alt="Logo" src="/ceewLogo@2x.png" />
            <img className="titleImage" alt="Title" src="/title@2x.png" />
            <button className="centerButton">Let's Go</button>
          </>
        ) : (
          <></>
        )}
